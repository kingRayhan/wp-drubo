    ...
    <div class="wrapper gray-bg">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 col-sm-12 col-xs-12">
							<div class="logo-area">
								<a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/1.png" alt="" /></a>
							</div>
						</div>
						<!-- Logo Area -->
						<!-- Menu Area -->
										...
										<li><a href="#">Shortcode</a>
											<div class="mega-menu">
												<ul class="single">
													...
													<li><a href="shortcode-testimonial-two.html">Testimonial Two</a></li>
													<li><a href="shortcode-portfolio.html">Portfolio</a></li>
													<li><a href="shortcode-counterup.html">Counter Up</a></li>
												</ul>
												<ul class="single">											
													<li><a href="shortcode-portfolio-two.html">Portfolio Two</a></li>
													<li><a href="shortcode-pricingtable.html">Pricing Table</a></li>
													<li><a href="shortcode-pricingtable-two.html">Pricing Table two</a></li>
													<li><a href="shortcode-ourblog.html">Blog</a></li>
													<li><a href="shortcode-ourblog-two.html">Blog Two</a></li>
													<li><a href="shortcode-progress.html">Progress Bar</a></li>
												</ul>
												<ul class="single">											
													<li><a href="shortcode-ourservice.html">Our Service</a></li>
													<li><a href="shortcode-ourservice-two.html">Our Service Two</a></li>
													<li><a href="shortcode-brand.html">Brand</a></li>
													<li><a href="shortcode-brand-two.html">Brand Two</a></li>
													<li><a href="shortcode-ourteam.html">Our Team</a></li>
													<li><a href="shortcode-wework.html">We Work</a></li>
												</ul>
												<ul class="single">											
													<li><a href="shortcode-aboutus.html">About Us</a></li>
													<li><a href="shortcode-choiceus.html">Choice Us</a></li>
													<li><a href="shortcode-map.html">Map</a></li>
													<li><a href="shortcode-mission-vission.html">Mission Vission</a></li>
													<li><a href="shortcode-specality.html">Speciality</a></li>
        ...
        <div class="slider-area">
			<div id="slider" class="nivoSlider">
				<img style ="display:none" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/home-1/1.jpg"  data-thumb="<?php echo get_template_directory_uri(); ?>/assets/images/slider/1.jpg"  alt="" title="#htmlcaption1"/>      
				<img style ="display:none" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/home-1/2.jpg"  data-thumb="<?php echo get_template_directory_uri(); ?>/assets/images/slider/2.jpg"  alt="" title="#htmlcaption2"/>
			</div>
				...
				<div class="row pt-50">
					...
					<div class="col-md-6 col-sm-12">
						<div class="specialty-image">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/other/about.png" alt="" />
						</div>
					</div>
					<!-- Speciality Image -->
				</div>
				...
				<div class="row pt-100 res-pt-xs-50">
					<div class="col-md-6 col-sm-6">
						<div class="video-area">
							<div class="img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/other/video-bg.png" alt="" />
						...
						<div class="grid-sizer grid-item c1">
							<div class="single-portfolio">
								<div class="image-box">
									...
									<a class="venobox" href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/b-1.jpg"><i class="zmdi zmdi-link"></i></a>
								</div>
							</div>
						</div>
						<!-- Portfolio Single -->
						...
						<div class="grid-item c2 c4">
							<div class="single-portfolio">
								<div class="image-box">
									...
									<a class="venobox" href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/b-2.jpg"><i class="zmdi zmdi-link"></i></a>
								</div>
							</div>
						</div>
						<!-- Portfolio Single -->
						...
						<div class="grid-item c1 c3">
							<div class="single-portfolio">
								<div class="image-box">
									...
									<a class="venobox" href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/b-3.jpg"><i class="zmdi zmdi-link"></i></a>
								</div>
							</div>
						</div>
						<!-- Portfolio Single -->
						...
						<div class="grid-item c3 c1 c5">
							<div class="single-portfolio">
								<div class="image-box">
									...
									<a class="venobox" href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/b-4.jpg"><i class="zmdi zmdi-link"></i></a>
								</div>
							</div>
						</div>
						<!-- Portfolio Single -->
			...
			<div class="container">
				...
				<div class="row pt-55">
						...
						<div class="single-blog">
							...
							<div class="blog-content">
								...
								<div class="post-info">
									...
									<div class="favorite-comment pull-right">
										<div class="favorite">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="single-blog">
							<div class="blog-img">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/2.jpg" alt="" /></a>
							</div>
							<div class="blog-content">
								<h6><a href="#">Lorem Ipsum is simply dummy</a></h6>
								<div class="post-info">
					...
					<div class="col-md-4 hidden-sm hidden-xs">
						<div class="single-blog">
							<div class="blog-img">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/3.jpg" alt="" /></a>
							</div>
							<div class="blog-content">
								<h6><a href="#">Lorem Ipsum is simply dummy</a></h6>
								<div class="post-info">
					...
					<div class="brand-carsoul">
						...
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/1.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/2.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/3.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/4.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/5.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
						<div class="col-md-12">
							<div class="brand-single">
								<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/6.jpg" alt="" /></a>
							</div>
						</div>
						<!-- Brand Single -->
						<!-- Brand Single -->
		...
		<!-- Google Map Area End -->
        <!-- Start footer area -->
        <footer class="footer-area bg-3 pt-110 pb-95">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
